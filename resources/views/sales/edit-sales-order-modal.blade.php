...
<div class="modal-header pd-x-20">
	<h6 class="modal-title"><strong>Editar Observaciones / Remito / Factura Final </strong></h6>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6">
            <label class="custom-control custom-checkbox">
                ...
                <span class="custom-control-label">Remito</span>
            </label>
        </div>
        @else
        <div class="col-xs-12 col-sm-6 col-md-6">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <label class="custom-control custom-checkbox">
                ...
                <span class="custom-control-label">Factura Final</span>
            </label>
        </div>
        @else
        <div class="col-xs-12 col-sm-6 col-md-6">
