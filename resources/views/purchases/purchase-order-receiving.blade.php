		                        ...
		                        <table class="table table-striped table-bordered" id="product-table">
		                            ...
		                            <tbody>
		                                ...
		                                <tr class="add-sec">
		                                    ...
		                                    <td class="text-center">
		                                        <strong>
		                                        	{{$productDetail->required_qty - $productDetail->accept_qty}}
		                                        </strong>
		                                    </td>
		                                    <td>
		                                    	<span @if(($productDetail->required_qty - $productDetail->accept_qty)<1) hidden @endif>
		                                    		{!! Form::number('received_qty[]',null,array('id'=>'received_qty','class'=> $errors->has('received_qty') ? 'form-control is-invalid state-invalid received_qty' : 'form-control received_qty', 'placeholder'=>'Receive qty', 'autocomplete'=>'off','min'=>'1','max'=> ($productDetail->required_qty - $productDetail->accept_qty))) !!}
		                                    	</span>
		                                        <span @if(($productDetail->required_qty - $productDetail->accept_qty)>0) hidden @endif class="text-success">
		                                        	Received
		                                        </span>
		                                    </td>
		                                </tr>
