...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            <tr class="top">
                <td colspan="4">
                    <table>
                        <tr>
                            <td class="title">
                                <img src="https://www.dormicentro.com/imagenes/logo-d.png" height="80px" width="200px">
                            </td>
            ...
            @endforeach
            <?php
                $amount = ($booking->amount-$booking->shipping_charge)+$booking->coupon_discount;
            ?>
            ...
            <tr class="total">
                ...
                <td>
                   <center>${{number_format($amount, 2, '.', ',')}}</center>
                </td>
            </tr>
            <tr class="total">
                <td></td>
             ...
             <tr class="total">
                <td></td>
                <td colspan="2"><strong>Total Envío:</strong> </td>
                <td>
            ...
            <tr class="total">
                <td></td>
                <td colspan="2"><strong>Código promocional ::</strong> </td>
                <td>
