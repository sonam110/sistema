...
class Wsaa {
    ...
    const CERT_HOMOLOGACION = "./key/homologacion/possistem.crt"; # Certificado X.509 otorgado por AFIP
    const PRIVATEKEY_HOMOLOGACION = "./key/homologacion/claveprivada.key"; # Clave privada de la PC
    const WSDL_PRODUCCION = "/wsdl/produccion/wsaa.wsdl";
    const URL_PRODUCCION = "https://wsaa.afip.gov.ar/ws/services/LoginCms"; 
    const CERT_PRODUCCION = "/key/produccion/posSistem_342eb85574578d5a.crt";
    const PRIVATEKEY_PRODUCCION = "/key/produccion/claveprivada.key";
