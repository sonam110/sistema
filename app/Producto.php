...
class Producto extends Model
{
	use Sluggable;
	protected $fillable = [
        'nombre', 'item_id', 'categoria_id', 'marca_id', 'modelo_id', 'medida_id', 'altura_id', 'precio', 'stock', 'tecnologia_id', 'garantia_id', 'postura_id', 'oferta', 'destacado', 'novedad', 'activo', 'slug', 'item_imagen', 'imagen'
    ];
